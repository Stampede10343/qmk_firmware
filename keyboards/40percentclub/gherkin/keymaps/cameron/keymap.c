...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ortho_3x10(
      ...
      LCTL_T(KC_Z), LT(1, KC_X),  LT(2, KC_C), KC_V,   KC_BSPC, LT3_SPC, KC_B,    KC_N,    KC_M,    KC_GESC
      ),
  ...
  [3] = LAYOUT_ortho_3x10(
      KC_DEL,  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS, KC_TRNS, KC_LBRC, KC_RBRC,  KC_MINS,
      KC_TAB,  KC_TRNS, KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_SCOLON,
      KC_BSLS, KC_TRNS, KC_TRNS,  KC_TRNS,  KC_LSFT,   KC_TRNS, KC_COMM, KC_DOT,  KC_QUOTE, KC_SLASH
      )
